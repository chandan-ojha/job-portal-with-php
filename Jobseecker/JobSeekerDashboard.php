...
<html class="no-js" lang="zxx">
	...
	<li>
	<a href="../job_details.php" target="_blank">
	<i class="glyphicon glyphicon-edit"></i>
	Apply For Jobs </a>
	</li>
	<li>
	<a href="Resume/CreateResume.php" target="_blank">
	<i class="glyphicon glyphicon-folder-open"></i>
	Create Resume </a>
	</li>
	<li>
	<a href="Resume/ViewResume.php" target="_blank">
	<i class="glyphicon glyphicon-folder-open"></i>
	View Resume </a>
	</li>
	...
	<div class="gallery">
	<a target="_blank" href="../job_details.php">
	...
	<div class="gallery">
	<a target="_blank" href="Resume/CreateResume.php">
