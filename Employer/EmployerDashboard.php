...
<html class="no-js" lang="zxx">
	...
	<li>
	<a href="SearchResume.php" target="_blank">
	...
	<h4 >Welcome Mr. Recruiter! </h4>
	<br> 
	
	<div class="gallery">
	<a href="SearchResume.php" target="_blank">
	<img src="images/cv-search.png" alt="images/Search Jobs" width="600" height="400">
	</a>
	<div class="desc">Search CV</div>
	</div>
