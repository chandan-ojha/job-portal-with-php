...
<html class="no-js" lang="zxx">
	...
	<body>
		...
		<div class="location">
		<p> <i class="fa fa-map-marker"></i> Mirpur-1,Dhaka</p>
		</div>
		<div class="location">
		...
		<div class="form-group"> 
		<label>Name</label>
		<input type="text" class="form-control" name="jobseekername"  required>
		</div>
		<div class="form-group"> 
		<label>Portfolio link</label>
		<input type="text" class="form-control" name="portfoliolink"  required>
		</div>					
		...
		<ul>
		<li>Published on: <span>12 Aug, 2020</span></li>
		<li>Vacancy: <span>2 Position</span></li>
		<li>Salary: <span>50k - 120k/y</span></li>
		<li>Location: <span>Mirpur-1,Dhaka</span></li>
